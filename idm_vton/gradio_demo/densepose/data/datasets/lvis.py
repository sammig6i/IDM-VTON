...
from .coco import DENSEPOSE_ALL_POSSIBLE_KEYS, DENSEPOSE_METADATA_URL_PREFIX, CocoDatasetInfo, get_metadata
...
DATASETS = [
  ...
  CocoDatasetInfo(
    name="densepose_lvis_v1_ds1_val_v1", images_root="coco_", annotations_fpath="lvis/densepose_lvis_v1_ds1_val_v1.json"
  ),
  CocoDatasetInfo(
  ...
  CocoDatasetInfo(
    name="densepose_lvis_v1_ds2_val_v1", images_root="coco_", annotations_fpath="lvis/densepose_lvis_v1_ds2_val_v1.json"
  ),
  CocoDatasetInfo(
...
def _combine_images_with_annotations(
  dataset_name: str, image_root: str, img_datas: Iterable[Dict[str, Any]], ann_datas: Iterable[Iterable[Dict[str, Any]]]
):
  dataset_dicts = []
...
def register_dataset(dataset_data: CocoDatasetInfo, datasets_root: Optional[str] = None) -> None:
  ...
  def load_annotations():
    return load_lvis_json(
      annotations_json_file=annotations_fpath, image_root=images_root, dataset_name=dataset_data.name
    )
